...
Status test_ecopelan_my_string_init_c_string_with_invalid_c_string(char* buffer, int length);
...
//Status test_ecopelan_get_size_with_invalid_hMy_string(char* buffer, int length);

//test my_string_compare//
//Status test_ecopelan_string_compare_with_invalid_hLeft_string(char* buffer, int length);
//Status test_ecopelan_string_compare_witn_invalid_hRight_string(char* buffer, int length);
...
//Status test_ecopelan_string_empty_with_invalid_hString(){}
...
//Status test_ecopelan_string_destroy_with_invalid_phString(){}
