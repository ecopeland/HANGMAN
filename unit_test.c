...
int main(int argc, char* argv[])
{
 ...
 test_string_push_back_with_invalid_hString_returns_FAILURE,
 test_string_push_back_returns_SUCCESS,
 test_string_pop_back_with_invalid_hString_returns_FAILURE,
 test_string_pop_back_returns_SUCCESS,
 test_string_pop_back_returns_FAILURE_if_string_empty,
 test_string_at_with_invalid_hString_returns_NULL,
 test_string_at_returns_nonNULL,
 test_string_at_with_index_out_of_bounds_returns_NULL,
 test_string_c_str_with_invalid_hString_returns_NULL,
 ...
 test_string_concat_with_invalid_hResult_returns_FAILURE,
 test_string_concat_with_invalid_hAppend_returns_FAILURE,
